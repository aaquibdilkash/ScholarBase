import { renderScholarBaseHero } from "@/lib/emails/brand";
...
<html lang="en">
  ...
  <body style="margin:0;padding:24px;background:#e1e6ee;font-family:-apple-system,BlinkMacSystemFont,'Segoe UI',Roboto,Helvetica,Arial,sans-serif;color:#1c2330;line-height:1.6;">
    <table role="presentation" width="100%" border="0" cellspacing="0" cellpadding="0">
      <tr>
        <td align="center">
          <table role="presentation" width="100%" border="0" cellspacing="0" cellpadding="0" style="max-width:600px;background:#ffffff;border:1px solid #cbd5e1;border-top:4px solid #3b82f6;border-radius:16px;overflow:hidden;">
            <tr>
              <td style="padding:34px 32px 36px;background:#0f172a;text-align:center;">
            ...
            <tr>
              <td style="padding:34px 40px 38px;">
                ...
                <div style="margin:0 0 28px;font-size:16px;line-height:1.75;color:#475569;">${safeBody}</div>
            ...
            <td style="border-radius:7px;background:#020617;">
                      <a href="${safeInviteUrl}" target="_blank" rel="noreferrer" style="display:inline-block;padding:13px 28px;color:#ffffff;text-decoration:none;font-size:14px;font-weight:700;">${safeCtaLabel}</a>
                    </td>
                  </tr>
                </table>
                ...
                <p style="margin:3px 0 0;font-size:13px;color:#64748b;">${safeSenderRole} · <a href="mailto:invitations@scholarbase.app" style="color:#64748b;text-decoration:none;">invitations@scholarbase.app</a></p>
              </td>
            </tr>
            <tr>
              <td style="padding:18px 32px;background:#f3f5f8;text-align:center;font-size:11px;color:#5b6577;">${safeFooterText}</td>
            </tr>
          </table>
        </td>
      </tr>
