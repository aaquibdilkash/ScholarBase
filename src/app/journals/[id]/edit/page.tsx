    ...
    >
      <JournalForm
        ...
        initialValues={{
          ...
          scopusQuartile: journal.scopusQuartile ?? "NONE",
          abdcRanking: journal.abdcRanking ?? "NONE",
          wosIndex: journal.wosIndex ?? "NONE",
          wosQuartile: journal.wosQuartile ?? "NONE",
          sjrQuartile: journal.sjrQuartile ?? "NONE",
          sjrScore: journal.sjrScore?.toString() ?? "",
          citeScore: journal.citeScore?.toString() ?? "",
