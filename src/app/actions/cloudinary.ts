 ...
 */
export async function deleteFromCloudinary(imageUrl: string | null | undefined): Promise<boolean> {
    ...
    try {
        ...
        const versionIndex = urlParts.findIndex((part) => part.startsWith("v") && /^\d+$/.test(part.slice(1)));
