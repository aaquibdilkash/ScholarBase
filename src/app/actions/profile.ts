...
export async function getProfileSections(
    ...
    const [
        ...
        prisma.jobVacancy.findMany({ where: { authorId: profileId, isDeleted: false }, take, orderBy: { createdAt: 'desc' }, include: { author: authorSelect, votes: votesSelect } }),
        prisma.phdAdmission.findMany({ where: { authorId: profileId, isDeleted: false }, take, orderBy: { createdAt: 'desc' }, include: { author: authorSelect, votes: votesSelect } }),
        prisma.researchEvent.findMany({ where: { authorId: profileId, isDeleted: false }, take, orderBy: { createdAt: 'desc' }, include: { author: authorSelect, votes: votesSelect } }),
