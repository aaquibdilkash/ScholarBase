...
export const MAX_INSTITUTION_NAME = 96;
export const MAX_INSTITUTION_REQUEST_EMAIL = 128;
export const MAX_INSTITUTION_WEBSITE = 128;
export const MAX_INSTITUTION_REQUEST_DETAILS = 512;
export const MAX_INSTITUTION_VERIFICATION_EMAIL = 128;
