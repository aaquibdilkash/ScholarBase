      ...
      <div className="sb-card p-6 md:p-8">
        ...
        <div className="flex gap-4 mb-8">
          {event.notificationLink && (
            <a href={event.notificationLink} target="_blank" rel="noopener noreferrer" className="sb-button-accent">
              View Brochure
            </a>
          )}
          {event.applyLink && (
            <a href={event.applyLink} target="_blank" rel="noopener noreferrer" className="sb-button-accent">
              Register Now
            </a>
          )}
        </div>
